"""Kubernetes execution backend — submits CogitoReviewRun CRD."""
...
class KubernetesExecutionBackend:
    """Submit execution by creating a CogitoReviewRun custom resource."""
    ...
    async def submit_execution(
        ...
        namespace = request.runtime_metadata.namespace or self._namespace
...
def _git_secret_keys(request: ReviewExecutionRequest) -> set[str]:
    ...
    return {k for k in keys if k.startswith("COGITO_REVIEW_ADO")}
