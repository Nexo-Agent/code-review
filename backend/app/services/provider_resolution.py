...
def build_review_runtime_config(
    ...
    return ReviewRuntimeConfig(
        ...
        gitlab_base_url=repo_integration.gitlab_base_url,
        gitlab_token=repo_integration.gitlab_token,
        gitlab_webhook_secret=repo_integration.gitlab_webhook_secret,
        bitbucket_token=repo_integration.bitbucket_token,
        bitbucket_webhook_secret=repo_integration.bitbucket_webhook_secret,
        bitbucket_dc_base_url=repo_integration.bitbucket_dc_base_url,
        bitbucket_dc_token=repo_integration.bitbucket_dc_token,
        bitbucket_dc_webhook_username=repo_integration.bitbucket_dc_webhook_username,
        bitbucket_dc_webhook_password=repo_integration.bitbucket_dc_webhook_password,
